package com.connect.sap.rfcwrapper.controllers;

import com.connect.sap.rfcwrapper.rfc.RemoteFunctionTemplate;
import com.connect.sap.rfcwrapper.services.SapRemoteFunctionCaller;
  ...
  public RemoteFunctionTemplate get() {
    RemoteFunctionTemplate template =
        new RemoteFunctionTemplate.Builder()
            ...
            .param("EMAIL", "victor.h.julio.hoyos@email.com")
